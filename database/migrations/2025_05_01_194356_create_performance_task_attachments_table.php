...
return new class extends Migration
{
    ...
    {
        Schema::create('performance_task_attachments', function (Blueprint $table) {
            $table->id();


            // Foreign key linking to the assignment_posts table
            $table->foreignId('performance_task_post_id')
                  ->constrained('performance_task_posts') // Ensures the post exists
    ...
    {
        Schema::dropIfExists('performance_task_attachments');
    }
};
