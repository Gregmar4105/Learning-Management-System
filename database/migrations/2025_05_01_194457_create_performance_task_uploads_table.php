...
return new class extends Migration
{
    ...
    {
        Schema::create('performance_task_uploads', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('performance_task_post_id');
            ...
            $table->foreign('performance_task_post_id')
                  ->references('id')
                  ->on('performance_task_posts')
    ...
    {
        Schema::dropIfExists('performance_task_uploads');
    }
};
